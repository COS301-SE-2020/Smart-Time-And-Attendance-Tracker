...
describe("PROJECT endpoints", ()=>{
    describe("POST, GET and DELETE api/project/", ()=>{
        ...
        ////delete a team
        it("delete a team - using the teamID ", (done) =>{
            chai.request('http://localhost:3000')
                 .delete("/api/project")
                 .set("Authorization", "Bearer " + adminToken)
...
describe("TEAM endpoints", ()=>{
    describe("POST, GET and DELETE api/team/", ()=>{
        ...
        it("edit team name", (done) =>{
            ...
            chai.request('http://localhost:3000')
                 ...
                 .end((err,res) => {
                    res.body.should.be.a('object');
                    res.should.have.status(200);
                    res.body.message.should.be.eq('Team name successfully edited');
                done(); 
                 })
        });
         ...
         ///////add member to team
         it("add member to team - "+team1ID, (done) =>{
            let data = {
                teamID:team1ID,
                userID:user1ID,
                userRole:"coder",
        ...
        ////// give user1 a role
        it("assign a team member a role ", (done) =>{
            let data = {
                teamID:team1ID,
                userID:user1ID,
                userRole:"coder",
        ...
        it("Get all teams - check for teamID= "+team1ID, (done) =>{
            chai.request('http://localhost:3000')
                 ...
                 .end((err,res) => {
                    res.body.should.be.a('object');
                    res.should.have.status(200);
                    teamLength=res.body.teams.length; ////set teamLength
                   /// console.log(res.body)
                done(); 
                 })
        });
        ...
        it("delete a team - using the teamID ", (done) =>{
            chai.request('http://localhost:3000')
                 ...
                 .end((err,res) => {
                    res.body.should.be.a('object');
                    res.should.have.status(200);
                    res.body.message.should.be.eq('Team successfully deleted ');
         ...
         ////// delete a member  -- fail because team has olready been deleted
         it("remove a user from a team ", (done) =>{
            let data = {
                teamID:team1ID,
                userID:user1ID
            }
            chai.request('http://localhost:3000')
                 .post("/api/team/removeTeamMember")
                 .set("Authorization", "Bearer " + adminToken)
                 .send(data)
                 .end((err,res) => {
                    /// console.log(res.body)
